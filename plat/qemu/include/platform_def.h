...
#define SEC_DRAM_SIZE			0x03f00000
...
/* Load bootdata part of zircon 10MB under top of BL32 memory region */
#define QEMU_ZIRCON_BOOTDATA_BASE	(BL32_LIMIT - 0x00a00000)
